...
public class Static {
    public static void main(String[] args) {
        // 클래스 변수
        // 클래스 내에 선언된 변수
        // 개별적이고 독립적인 값이 생성되고 저장되는 인스턴스 변수완는 달리
        ...
        System.out.println(m1.userid + "/" + m1.passwd + "/" + Member.allofMember);
        ...
        System.out.println(m2.userid + "/" + m2.passwd + "/" + Member.allofMember);
