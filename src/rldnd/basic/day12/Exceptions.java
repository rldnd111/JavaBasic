...
//        System.out.println("프로그램 끝3");
       ...
       try{
        ...
        try {
            System.out.println("1 ~ 9 사이의 정수를 입력해 주세요");
            int num = sc.nextInt();
        ...
        // ex) 임의의 성적 데이터를 입력받아(이름,국어,영어,수학)를 입력받아
