...
public class Collections {
    public static void main(String[] args) {
        ...
        System.out.println(nums.size()); // 리시트의 크기 출력
        ...
        System.out.println(members.get(0).userid.equals("def456"));
        System.out.println(members.get(1).userid.equals("def456"));
        System.out.println(members.get(2).userid.equals("def456"));
        // 반복문으로 코드를 최적화 시킴
