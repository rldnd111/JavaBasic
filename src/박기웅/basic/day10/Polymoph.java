...
public class Polymoph {
    public static void main(String[] args) {
        ...
        // paint 메서드로 구현해서 draw호출을 수월하게 바꿔봄
        // 여전히, draw메서드 호출시 동일한 클래스타입을 사용해야 함
        // 새로운 도형이 추가되면 paint메서드도 추가해야함
        paint(new Line());
        paint(new Circle());
        paint(new Triangle());
        ...
        // 실제 함수가 위치한 메모리상의 주소와 연결하는것을 의미
