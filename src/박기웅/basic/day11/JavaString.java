...
public class JavaString {
    public static void main(String[] args) {
        ...
        if(str1 == str3)
            System.out.println("str1과 str3이 저장 위치가 같음");
        ...
        // valueOf : 숫자를 문자로형으로 변환시 사용하는 메서드
        int height = 123;
        ...
        // 메모리를 절약할 수 있음
        // 따라서, + 를 이용하여 문자열을 결합하는 것 보다는
        // StrungBuilder를 이용하는 것이 더 나음
